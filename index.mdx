...
<div className="relative">
    ...
    <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
        ...
        ## Checkout our models
        <Columns>
            <Card title={"Mansa v1"} img={"/images/mansa.png"} cta={"quickstart"} href={"start/models"} arrow={"true"}>
        ...
        <Columns>
            <Card
                ...
                horizontal
            >
                convert podcast episodes into concise written summaries with timestamps.
            </Card>
            <Card
