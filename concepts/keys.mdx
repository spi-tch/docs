...
<Tip>
  ...
  We're working to add SDKs for other languages.
</Tip>
...
To get your API key, go to [https://spitch.studio/](https://www.spitch.studio/). After logging in, an API key is automatically generated for you. To get a new key, click the refresh button next to your API key and confirm.
