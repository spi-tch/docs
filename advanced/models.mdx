...
Mansa is a 1.4B parameter English-only Automatic Speech Recognition model optimized for African names and concepts, offering high transcription accuracy and low-latency performance.
...
<Warning>
Mansa currently supports <b>English</b> only. If you try to use it with any other language, the API will return an error.
</Warning>
## Getting Started 
<Info>
...
<ParamField path="special_words" type="comma separated list">
  You can use **special_words** to guide Mansa’s spellings of rare words such as names, locations and landmarks. By entering in a list of entity strings, Mansa will accurately recognize and transcribe those terms in your audio.
</ParamField>
